...
public class KindEditorController {
    ...
    public Map<String, Object> upload(HttpServletRequest request,HttpServletResponse response) throws ServletException, IOException,
        ...
        String savePath = application.getRealPath("/") + DIR_PATH;

        // 文件保存目录URL
        String saveUrl = request.getContextPath() + "/" + DIR_PATH;
    ...
    public void manage(HttpServletRequest request,
        ...
        String rootPath = application.getRealPath("/") + DIR_PATH;
        // 根目录URL，可以指定绝对路径，比如 http://www.yoursite.com/attached/
        String rootUrl = request.getContextPath() + "/" + DIR_PATH;
        // 图片扩展名
        String[] fileTypes = new String[] { "gif", "jpg", "jpeg", "png", "bmp" };

        //dirName 是KindEditor固定内容，目前提供了4种方式
        String dirName = request.getParameter("dir");
        if (dirName != null) {
