...
public class TestMail {
    ...
    public static void main(String[] args) throws Exception {
        ...
        message.setRecipient( Message.RecipientType.TO , new InternetAddress("343395957@qq.com"));
        //2.3 主题
        message.setSubject("第一个java发送邮件");
        //2.4 正文
        message.setContent("今晚拳皇约么<a href='http://www.7k7k.com'>点我</a>","text/html;charset=UTF-8");
